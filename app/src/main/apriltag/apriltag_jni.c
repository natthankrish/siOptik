...
JNIEXPORT void JNICALL Java_com_example_sioptik_ApriltagNative_native_1init
        (JNIEnv *env, jclass cls)
{
    ...
    jclass ad_cls = (*env)->FindClass(env, "com/example/sioptik/ApriltagDetection");
    if (!ad_cls) {
        __android_log_write(ANDROID_LOG_ERROR, "apriltag_jni",
 ...
 */
JNIEXPORT void JNICALL Java_com_example_sioptik_ApriltagNative_yuv_1to_1rgb
 ...
 */
JNIEXPORT void JNICALL Java_com_example_sioptik_ApriltagNative_apriltag_1init
 ...
 */
JNIEXPORT jobject JNICALL Java_com_example_sioptik_ApriltagNative_apriltag_1detect_1yuv
